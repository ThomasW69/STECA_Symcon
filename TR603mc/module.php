...
class STECA extends T2DModule
{
    ...
    protected $capvars = array(
        "Buffer" 	=>	array("ident" =>"Buffer",		"type" => self::VT_String,	"name" =>"Buffer",					"profile" => "",	        "pos" => -1),
        "LastUpdate"=>	array("ident" =>"LastUpdate",	"type" => self::VT_String,	"name" =>"LastUpdate",				"profile" => "",	        "pos" => 0),
        ...
        "Country" 	=> 	array("ident" => "Country", 	"type" => self::VT_String, 	"name" => "Ländercode", 			"profile" => "", 	        "pos" => 14),
        "Model" 	=> 	array("ident" => "Model", 		"type" => self::VT_String, 	"name" => "Modellvariante", 		"profile" => "",     	    "pos" => 15),
